...
class RegisterationPage2 extends StatefulWidget {

  final Students user;

  const RegisterationPage2({super.key, required this.user});

  @override
  State<RegisterationPage2> createState() => _RegisterationPage2State();
}

class _RegisterationPage2State extends State<RegisterationPage2> {
        ...
        body: SingleChildScrollView(
          ...
          Padding(
              ...
              child: FutureBuilder<List<Registeration>>(
                  future: _databaseService.registerationList(),
              ...
              child: Container(
                ...
                child: MaterialButton(
                  ...
                  onPressed: () {
                    ...
                    for (var registeration in subjectAddList) {
                      StudentRegis regis = StudentRegis(
                        amount: registeration["amount"],
                    ...
                    Navigator.push(
                        ...
                        MaterialPageRoute(
                            builder: ((context) =>
                                 RegisterationResultPage(user: widget.user))));
                  },
